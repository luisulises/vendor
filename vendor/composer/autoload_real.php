...
class ComposerAutoloaderInit161063ac4ca51fc49e6bcb5a58487262
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit161063ac4ca51fc49e6bcb5a58487262::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire161063ac4ca51fc49e6bcb5a58487262($fileIdentifier, $file);
        }
...
function composerRequire161063ac4ca51fc49e6bcb5a58487262($fileIdentifier, $file)
{
