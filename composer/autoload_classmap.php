...
$verdorDir = dirname(dirname(__DIR__));
$verdorFile = dirname(dirname(__FILE__));
$baseDir = dirname($verdorFile);

return array(
    'Attribute' => $verdorFile . '/symfony/polyfill-php80/Resources/stubs/Attribute.php',
    'Normalizer' => $verdorFile . '/symfony/polyfill-intl-normalizer/Resources/stubs/Normalizer.php',
    'PhpToken' => $verdorFile . '/symfony/polyfill-php80/Resources/stubs/PhpToken.php',
    'Stringable' => $verdorFile . '/symfony/polyfill-php80/Resources/stubs/Stringable.php',
    'UnhandledMatchError' => $verdorFile . '/symfony/polyfill-php80/Resources/stubs/UnhandledMatchError.php',
    'ValueError' => $verdorFile . '/symfony/polyfill-php80/Resources/stubs/ValueError.php',
